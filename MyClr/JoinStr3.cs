...
public class JoinStr3 : Microsoft.SqlServer.Server.IBinarySerialize
{
    /// <summary>
    ...
    public virtual void Accumulate(SqlString value, SqlString joinString, SqlBoolean IsDesc)
    {
        this.joinString = joinString.IsNull ? "," : joinString.Value;
        this.IsDesc = IsDesc.IsNull ? false : IsDesc.Value;
    ...
    public void Merge(JoinStr3 other)
    {
