...
public class JoinStr : Microsoft.SqlServer.Server.IBinarySerialize
{
    ...
    public virtual void Accumulate(SqlString value)
    {
    ...
    public SqlString Terminate()
    {
        ...
        if (intermediateResult != null && intermediateResult.Count > 0)
        {
            ...
            output = string.Join(",", intermediateResult.ToArray());// intermediateResult.ToString(0, intermediateResult.cou - (this.joinString == null ? 1 : this.joinString.Length));
        }
    ...
    public void Write(BinaryWriter w)
    {
        ...
        w.Write(string.Join(",", intermediateResult.ToArray()));
    }
}
